...
// import { FaCheckCircle, FaTimesCircle, FaUser, FaPlusCircle, FaList, FaEdit } from "react-icons/fa";
...
//         <h1 className="text-3xl font-bold mb-6 text-center">ลงทะเบียนกิจกรรม</h1>
